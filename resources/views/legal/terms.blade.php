...
@section('content')
<section class="leading-normal"><div class="text-2xl">Teilnahmebedingungen</div><p>Es gibt einige Punkte, auf die wir Dich im Vorfeld des Code+Design Camps deutlich hinweisen wollen. Wir erwarten von allen Teilnehmern, dass sie diese Hinweise lesen und auf dem Camp einhalten.</p>
   <ul>
   ...
   <li>
   Solltest du während des Camps krank werden oder aus sonstigen wichtigen Gründen nicht kommen kannst (egal ob an einem oder an mehreren Tagen), dann gib uns per Mail Bescheid (hello@code.design)</li>
